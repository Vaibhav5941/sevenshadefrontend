...
/**************************************** */
  ...
  const addressComponent = () => {
    return (
      <div style={{ width:md_matches?'90%': "90%", backgroundColor: "white", padding:md_matches?"0%": "1%" }}>
              ...
              <Box sx={{ mt: 1 }}>
                ...
                <div
                  style={{
                    ...
                    fontWeight: "bold",
                    textAlign: "left",
                    fontSize:md_matches?'2.5vw': "1.2vw",
                    marginTop: "5%",
                    marginBottom: md_matches?'2%':"5%",
                  }}
                >
                  ADD ADDRESS
                </div>
                ...
                <label
                  style={{ width: "100%", fontWeight: "bold", color: "#999",fontSize:md_matches?'2.5vw':'2.2vh' }}
                >
                  FIRST NAME :
                </label>
                <div style={{marginBottom:md_matches?5:20,}}>
                <TextField
                  margin='none'
                  fullWidth
                  id="firstname"
...
InputProps={{
          style: { fontSize:md_matches?'3vw':'1.2vw', height:sm_matches?35:55 } // Adjust the font size and height here
        }}
        InputLabelProps={{
          style: { fontSize: 5 } // Adjust the font size of the label here
        }}
        sx={{ '& .MuiInputBase-root': { height: 9 } }} // Adjust the height of the input box here
      />
    </div>


                <label
                  style={{ width: "100%", fontWeight: "bold", color: "#999",fontSize:md_matches?'2.5vw':'2.2vh',marginTop:md_matches?'20%':'2%' }}
                >
                  LAST NAME :
                </label>
                <div style={{marginBottom:md_matches?5:20,}}>
                ...
                <div style={{marginBottom:md_matches?10:20}}>
                <TextField
                  margin="none"
                  fullWidth
                  id="mobile"
                ...
                >
                  <label style={{ fontWeight: "bold", color: "#999",fontSize:md_matches?'2.5vw':'2.2vh' }}>
                    COUNTRY:
                  </label>
                  <div style={{marginBottom:md_matches?5:20,}}>
                  <div style={{ width: "100%" }}>
                    <FormControl style={{ width: "100%" }}>
                      ...
                      <Select
                        ...
                        style={{ width: "100%",fontSize: md_matches ? '2.5vw' : '2.2vh', height: sm_matches ? 40 : 55 }}
                      >
                ...
                <Button
                  ...
                  fullWidth
                  variant="contained"
                  sx={{ mt:md_matches?4: 3, mb:md_matches?1: 2 }}
            ...
            <Copyright sx={{ mt:md_matches?3: 8, mb:md_matches?2: 4 }} />
          </Container>
        </ThemeProvider>
      </div>
    );
            ...
            >
              <button
                style={{
                  ...
                  color: "white",
                  fontWeight: "bold",                         //
                  fontSize:md_matches?'2.2vw': '1.2vw',
                  marginTop: 16,
                  paddingBlock: 4,
                  justifyContent: "space-evenly",
                  paddingRight: 10,
    ...
    >
      <div
        style={{
          display: "flex",
          alignItems: "left",
          marginLeft:md_matches?'0%': "10%",
          marginRight:md_matches?'0%': "10%",
        }}
      >
        <Grid container spacing={md_matches?0:2} style={{ alignItems: "left" }}>
          <Grid item xs={md_matches?8:12} md={md_matches?5:8}>
            <div
              style={{
                padding: "1%",
                color: "#000",
                ...
                justifyContent: "space-evenly",
                textAlign: "left",
                fontSize:md_matches?'3.5vw': "2vw",
                fontFamily: "League Gothic",
                letterSpacing:md_matches?1: 1,
                display: "flex",
                alignItems: 'center',
                marginTop:md_matches?'10%':'0%'
              }}
            >
            ...
            <div
              style={{
                width:md_matches?"90%": "90%",//1block
                backgroundColor: "white",
                padding: "1%",
                marginBottom: "5%",
                paddingLeft:md_matches?'5%': "5%",
                paddingTop: "2%",
                marginTop: "5%",
              }}
            >
              <Box sx={{ mt: 1 }}>
                <div
                  style={{
                    ...
                    fontWeight: "bold",
                    textAlign: "left",
                    fontSize:md_matches?'3vw': "1.3vw",
                    marginBottom:md_matches?'4%': "2%",
                  }}
                >
                  Delivery Address
                </div>
            ...
            <div style={{width:md_matches?'90%':'90%',display:'flex',flexDirection:'column'}}>
            <div
              style={{
                width:md_matches?'100%': "90%",
                backgroundColor: "white",
                paddingLeft:md_matches?'5%': "5%",
                marginTop:"5%",
            ...
            >
                  ...
                  <div
                    style={{
                      ...
                      textAlign: "left",
                      fontSize:md_matches?'3vw': "1.3vw",
                      marginTop:md_matches?'5%': "5",
                      marginBottom:md_matches?'2%': "1%",
                    }}
                  >
                    PAYMENT
                  </div>
            ...
            <div
              style={{
                width:md_matches?'95%': "90%",        //
                padding:md_matches?'5%': "2%",
                fontWeight: "bold",
          ...
          <Grid item xs={md_matches?4:4}>
            <div
              style={{
                backgroundColor: "white",
                width: "100%",
                padding:md_matches?"1%": "5%",
                marginTop:md_matches? "50%":"27.5%",
              }}
            >
              {showTotal()}
            </div>
